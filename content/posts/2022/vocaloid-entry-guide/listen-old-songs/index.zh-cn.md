...
同样的，我们也有一个YouTube版本，但是是1000万次的浏览量：（因为在Youtube上达到100万播放量太容易了）
...
> 同样的表格可以用于YouTube列表，但我们用1000万的浏览量来代替100万的浏览量，同样的替换适用于本帖其余部分提到的 "100万浏览量"。

基本上，我们根据发布日期和达到100万次浏览所需的时间，将百万传说曲列表划分为若干格。接下来，我们逐行走动该表。在每一行中，我们从左到右走遍每个格。在每个格中，我们找到满足条件的歌曲。例如，第一格是在2007年发布并在100天内达到100万浏览量的V曲。然后，当我们听完这一格的歌曲后，就可以进入下一格了。
